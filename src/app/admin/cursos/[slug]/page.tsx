...
export default async function EditarCursoPage({ params }: { params: { slug: string } }) {
  ...
  // Contador de inscritos totales — sirve para el enlace a la lista y para
  // que el admin sepa si va a impactar personas antes de operar.
